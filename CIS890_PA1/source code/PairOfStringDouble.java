 ...
 * 
 */
public class PairOfStringDouble implements WritableComparable<PairOfStringDouble> {
	 ...
	 *            the right element
	 */
	public PairOfStringDouble(String left, double right) {
		set(left, right);
	}
	...
	public boolean equals(Object obj) {
		PairOfStringDouble pair = (PairOfStringDouble) obj;
	 ...
	 *         <code>obj</code>.
	 */
	public int compareTo(PairOfStringDouble obj) {
		PairOfStringDouble pair = (PairOfStringDouble) obj;

		String pl = pair.getLeftElement();
		double pr = pair.getRightElement();
	 ...
	 */
	@Override
	public PairOfStringDouble clone() {
		return new PairOfStringDouble(this.leftElement, this.rightElement);
	}
	...
	static { // register this comparator
		WritableComparator.define(PairOfStringDouble.class, new Comparator());
	}
}